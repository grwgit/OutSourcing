			...
			<div class="container">
				<div class="gallery-grids">
                    ...
                    <div class=" gallery-grid1">
							<a href="tongozhi.jsp" class="b-link-stripe b-animate-go  thickbox">
								<img class="img-responsive port-pic" src="images/g4.jpg" />
								<div class="b-wrapper">
									<h2 class="b-animate b-from-left    b-delay03 ">
										<span></span>
										<button><font size="+2">查看通知</font></button>
									</h2>
								</div>
							</a>
						</div>
						<div class=" gallery-grid1">
							<a href="qtmessage.jsp" class="b-link-stripe b-animate-go  thickbox">
								<img class="img-responsive port-pic" src="images/g3.jpg" />
								<div class="b-wrapper">
									<h2 class="b-animate b-from-left    b-delay03 ">
										<span></span>
										<button><font size="+2">全体消息</font></button>
									</h2>
								</div>
							</a>
						</div>
						<div class=" gallery-grid1">
							<a href="hfmessage.jsp" class="b-link-stripe b-animate-go  thickbox">
								<img class="img-responsive port-pic" src="images/g4.jpg" />
								<div class="b-wrapper">
									<h2 class="b-animate b-from-left    b-delay03 ">
										<span></span>
										<button><font size="+2">回复消息</font></button>
									</h2>
								</div>
							</a>
						</div>
