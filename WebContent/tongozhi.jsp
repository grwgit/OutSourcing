		...
		<div id="gal" class="gallery">
			<div class="container">
				...
				<div class="col-md-12 service-left">
					...
					<li><a href="message.jsp">今晚七点所有管理员老地方开会！</a></li>
					<li><a href="message.jsp">祝管理员们新年快乐！</a></li>
					<li><a href="message.jsp">明天发工资。</a></li>
					<li><a href="message.jsp">各位管理员注意加强小区安保。</a></li>
					<li class="sed-ut"><a href="message.jsp">各位管理员们好，我是超级管理员，负责管理管理员。</a></li>
					</ul>
				</div>
