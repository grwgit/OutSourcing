...
<!--header-->
	...
	<div class="header-bottom-top">
		...
		<div class="services" >
			<div class="container">
			<div class="service-top" align="center">
				<h2><strong>回复消息</strong></h2>
			</div>
				<div class="services-us">
				
					<div class="col-md-6 ">
						<img class="img-responsive" src="images/gg.jpg" />
						
					</div>
				    <div class="col-md-6 us-head">
					<h5>这是一个回复消息的样例</H5>
					<P>管理员，为什么临时用户申请失败？</p>
                    <a href="hmessage.jsp" class="more-left">回 复</a>
                    <a href="#" class="more-left">删 除</a>
					</div>
				<div class="clearfix"> </div>
				</div>
</div>
