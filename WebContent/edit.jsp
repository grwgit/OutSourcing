			...
			<form method="post" action="ChangeServlet">
				<div class="grid-contact">
					<div class="col-md-6 contact-left">
						...
						<input type="text" name ="name" value=<%=name%> onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
					</div>
					<div class="col-md-6 contact-left">
						<p class="your-para"> 联系方式<span>*</span></p>
						<input type="text" name ="phone" value=<%=phone%> onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
					</div>
					<div class="clearfix"> </div>
				</div>
               <div class="grid-contact">
					<div class="col-md-6 contact-left">
						...
						<input type="text" name ="id" value=<%=id%> onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
					</div>
					<div class="col-md-6 contact-left">
						<p class="your-para"> 状态<span>*</span></p>
						<input type="text" name ="status" value=<%=status%> onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
					</div>
					<div class="clearfix"> </div>
				</div>
                <div class="grid-contact">
                    ...
                    <p class="your-para"> 证件照片<span>*</span>
                  ...
                  <input type="file" name="file1" class="file" id="fileField" size="28" onchange="document.getElementById('textfield').value=this.value" />
                   ...
                   <p>
					...
					<div class="col-md-4 contact-left">
                    <p class="your-para"> 日常照片1<span>*</span>
                    <img class="img-responsive" src="images/1.jpg">
                    </p>
                    <p>
                    </p>
                  ...
                  <input type="file" name="file2" class="file" id="fileField" size="28" onchange="document.getElementById('textfield').value=this.value" />
					...
					<div class="col-md-4 contact-left">
                    <p class="your-para"> 日常照片2<span>*</span>
                    <img class="img-responsive" src="images/1.jpg">
                    </p>
                    <p>
                    </p>
